...
## 🍢 超白話特別篇：用「烤肉後大家都拉肚子」看懂 2×2 表與風險比

> 2×2 表、侵襲率、風險比、卡方檢定……這章名詞有點多？別怕。這一段先把護理之家放一邊，改用一個**每個人都怕遇到**的慘案——**「班遊烤肉後，全班一半的人都在跑廁所」**——把整章最核心的一招講到讓國中生也秒懂。這一招學會了，後面的 2×2 表、RR、卡方全都是它的變身。

### 一場班遊烤肉的悲劇

40 個同學去班遊烤肉，回來後**有 20 個人開始拉肚子** 😖。老師想查：**到底是哪道菜害的？**

桌上的菜排成一排「嫌疑犯」：🥗 生菜沙拉、🌭 烤香腸、🍚 白飯、🍗 烤雞……每一道都有可能。怎麼揪出真兇？

### 破案關鍵：每道菜辦一場「吃過 vs 沒吃」的 PK 🥊
...
如果某道菜「**吃過的人拉肚子率遠高於沒吃的人**」，它嫌疑就很大。反過來，如果兩隊拉肚子的比例**差不多**，那道菜大概是無辜的。

### 為什麼一定要看「沒吃的人」？（新手第一大雷）

你可能會說：「我去問拉肚子的人吃了什麼不就好了？」——**這正是最經典的錯誤！**

> 🚨 **「拉肚子的人裡，有八成吃了沙拉！所以是沙拉！」** —— 這句話其實**什麼都沒證明**。因為搞不好**沒拉肚子的人**也有八成吃了沙拉啊！（那就代表沙拉根本沒差。）

> ⚽ 一句話記住：**只數「其中一隊進了幾球」，不算比賽。** 你一定要同時看「吃沙拉那隊的命中率」**對上**「沒吃那隊的命中率」，兩隊 PK 才知道沙拉到底有沒有問題。這個「別忘了跟沒暴露的人比」，是整個流行病學的地基。

### 侵襲率：關鍵在「分母」

我們比的不是「幾個人生病」，而是**每一隊裡「生病的比例」**——這個比例就叫**侵襲率（attack rate）**：

$$\text{侵襲率} = \frac{\text{這一隊生病的人數}}{\text{這一隊的總人數}}$$

> 🔑 **分母才是關鍵**：「3 個人吃了烤雞後生病」聽起來很嚇人？但如果**總共有 100 個人吃烤雞**，那侵襲率只有 3%；可是如果**只有 3 個人吃烤雞、而且全中獎**，那就是 100%！同樣「3 個人生病」，意義天差地別——**看數字前，先問分母是多少。**

```{figure} images/bbq_attack_rate.svg
:name: fig-bbq-attack-rate
:alt: 烤肉 2×2 表與侵襲率 PK：生菜沙拉組吃的人 80%（16/20）拉肚子、沒吃的 20%（4/20），RR=4.0 是頭號嫌疑犯，並展開成 a=16,b=4,c=4,d=16 的 2×2 表；白飯組吃與沒吃都是 50%，RR=1.0 清白；並提醒「只數生病的人會被騙」的分母陷阱，最後橋接到護理之家 shower_use × 感染
:width: 100%

左：生菜沙拉「吃過隊」80% vs「沒吃隊」20%，RR=4.0，頭號嫌疑犯——這兩排小人其實就是一張 2×2 表；右：白飯兩隊都 50%，RR=1.0，清白，並提醒別忘了分母。
```
...
# 40 位同學班遊烤肉，20 人拉肚子。每道菜都做一張 2×2 表：
# 比較「吃過這道菜的人」和「沒吃的人」，各自的拉肚子率（侵襲率）
# 每個值 = (吃且拉, 吃沒拉, 沒吃且拉, 沒吃沒拉)
foods = {
    "生菜沙拉": (16, 4, 4, 16),
    "烤香腸":   (10, 8, 10, 12),
    "白飯":     (10, 10, 10, 10),
...
for name, (a, b, c, d) in foods.items():
    ar_eat = a / (a + b)      # 吃這道菜的人的侵襲率
    ar_skip = c / (c + d)     # 沒吃的人的侵襲率
    rr = ar_eat / ar_skip
    print(f"{name}：吃的人 {ar_eat:.0%} 拉肚子 vs 沒吃的 {ar_skip:.0%} → RR = {rr:.1f}")

# 頭號嫌疑犯是生菜沙拉（RR 最大）。這差距是真的，還是 40 人剛好運氣不同？→ 卡方檢定
a, b, c, d = foods["生菜沙拉"]
chi2, p, dof, _ = chi2_contingency([[a, b], [c, d]], correction=False)
print(f"\n生菜沙拉 2×2 卡方檢定：p = {p:.4f}（p < 0.001 → 這麼大的差距幾乎不可能只是巧合）")
```

跑出來會看到：

```text
生菜沙拉：吃的人 80% 拉肚子 vs 沒吃的 20% → RR = 4.0
烤香腸：吃的人 56% 拉肚子 vs 沒吃的 45% → RR = 1.2
白飯：吃的人 50% 拉肚子 vs 沒吃的 50% → RR = 1.0

生菜沙拉 2×2 卡方檢定：p = 0.0001（p < 0.001 → 這麼大的差距幾乎不可能只是巧合）
```

### RR = 4 是什麼感覺？RR 就是「清白量表」

**風險比（RR）= 吃的那隊的侵襲率 ÷ 沒吃那隊的侵襲率。**

> 🎟️ **RR = 4 不是「多 4%」，是整整 4 倍**——吃了那道菜，踩雷機率直接翻兩番。想像同一款刮刮樂：**吃過沙拉的人，每 4 張就中一張「拉肚子」；沒吃的人，要 16 張才中一張。**

RR 就像一把「清白量表」，**離 1 越遠、越可疑**：
...
就算沙拉兩隊命中率有差，也**有沒有可能只是這 40 個人剛好運氣不同**？

> 🎲 **卡方檢定（chi-square test）就是在問**：「這個差距，大到不像是骰子隨便擲出來的巧合嗎？」它會給你一個 **p 值**。沙拉的 **p = 0.0001** 意思是：**假如沙拉其實無辜，純靠運氣湊出這麼大的差距，機率不到萬分之一**——所以我們幾乎可以確定，沙拉的嫌疑是玩真的。

### ⚠️ 四個誠實的但書

1. **統計只能揪出「嫌疑犯」，不能「定罪」**：RR 高只代表沙拉**可疑**，真正定罪要靠實驗室從沙拉驗出病菌 + 後續調查。統計找方向，證據下結論。
2. **菜太多道，總會有一道「剛好」看起來可疑**：如果你一次比 20 道菜，就算全部無辜，也可能有一兩道純靠運氣 p 值變小。看到嫌疑犯，別急著開香檳（這個「多重比較」問題，之後會學怎麼校正）。
3. **有些菜總是「成雙成對」出現**：沙拉常常配沙拉醬一起吃，到底誰才是真兇？當兩個暴露綁在一起、互相頂罪，就需要 **Ch05 的分層分析**來拆穿（還記得「大腳丫」嗎？）。
4. **某一格人數太少（< 5）時，卡方會不準**：這時改用 **Fisher 精確檢定**（本章正文有教）。

> 💡 小補充：這裡我們**認識全班每一個人**、也知道每個人吃了什麼，屬於**世代研究**，用 **RR** 剛剛好。要是我們只找得到「已經生病的人」、得回頭問他們吃了什麼，那才要改用 **OR（勝算比）**——就是本章正文那個「賭場賠率」。

### 讀圖小抄（存起來）

| 你看到… | 白話意思 |
|---|---|
| 只看「生病的人吃了什麼」 | ❌ 忘了分母，會被騙 |
| 「吃的隊侵襲率 vs 沒吃的隊侵襲率」 | ✔ 正確比法（2×2 表的靈魂） |
| 侵襲率 | 這一隊裡生病的**比例**（分母 = 這隊總人數） |
| RR ≈ 1 | 兩隊一樣 → 這個暴露大概無辜 |
| RR 遠大於 1 | 吃的人慘很多 → 嫌疑重大 |
| RR < 1 | 吃的人反而比較少中 → 可能是保護因子（如疫苗） |
| 卡方 p 值很小（< 0.05） | 這差距不太可能只是運氣 |
| 某格 < 5 人 | 改用 Fisher 精確檢定 |
...
| 烤肉世界 | 護理之家真實案例 |
|---|---|
| 每一道菜（沙拉、白飯…） | 每一個暴露（`shower_use`、`hydrotherapy_use`…） |
| 吃了 / 沒吃這道菜 | 有洗澡 / 沒洗澡 |
| 拉肚子 / 沒事 | 感染 / 未感染 |
| 「吃沒吃 × 拉沒拉」排成田字格 | 2×2 表（a / b / c / d） |
| 吃過那隊的拉肚子率 | 洗澡者的侵襲率 |
| 沒吃那隊的拉肚子率 | 未洗澡者的侵襲率 |
| 兩隊命中率相除 | 風險比 RR |
| 「這差距是不是運氣？」 | 卡方檢定 / p 值 |
...
你剛剛在烤肉桌上學會的每一招——分兩隊 PK、算侵襲率、別忘分母、RR 清白量表、卡方問運氣——**就是本章 Step 2–5 在護理之家資料上做的事**。現在往下看那些 2×2 表和 RR、OR，是不是突然變親切了？😉
