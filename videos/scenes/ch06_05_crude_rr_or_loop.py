...
class Ch06CrudeRrOrLoopScene(EpiBaseScene):
    ...
    def show_title(self, duration: float = 3.0, **kwargs) -> None:
        self.show_title_card("單變項 crude RR vs OR", "for loop 並排比較", duration=duration)
    ...
    def show_code_demo(self, duration: float = 10.0, **kwargs) -> None:
        ...
        self._code_block("雙模型 loop 範例", kwargs.get("code", ""), duration)
    ...
    def show_extra_banner(self, duration: float = 2.0, **kwargs) -> None:
        self.show_section_banner(ExtraExampleBanner("額外範例：COVID 長者住院風險"), duration=duration)
    ...
    def show_blindspot_banner(self, duration: float = 2.0, **kwargs) -> None:
        self.show_section_banner(BlindSpotBanner("for loop 地雷 3 選"), duration=duration)
    ...
    def show_outro(self, duration: float = 3.0, **kwargs) -> None:
        ...
        h = Text("下一集：多變項 Table 2", font=FONT_CJK, font_size=28, color=ACCENT_ORANGE).move_to(ORIGIN + UP * 0.5)
        s = Text("一次調整一打變數", font=FONT_CJK, font_size=22, color=TEXT_SECONDARY).next_to(h, DOWN, buff=0.4)
